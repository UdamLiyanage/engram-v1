...
<html lang="en">
    ...
    <body class="text-center">
        <form class="form-takesurvey" action="{{route('phq2_get')}}" method="post">
            @csrf
            <img class="mb-4" src="{{asset('images/logo.png')}}" alt="" width="180" height="150">
            <h1 class="h3 mb-3 font-weight-normal">Welcome to Engram Diagnosis</h1>
